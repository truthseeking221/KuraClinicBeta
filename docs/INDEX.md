---
id: DOCS-INDEX
title: Kura Platform documentation index
type: index
tags: [docs, index, clinic, product]
owner: docs
---

# Kura Platform documentation index

## Clinic product truth
...
- [Source register](kura-clinic/05-traceability/source-register.md) — authority order, conflicts, limitations, and open decisions.

## Workspace entry points

- [Repository setup and architecture overview](../README.md)
- [Storybook reuse and component intake](architecture/storybook-reuse-and-component-intake.md) — mandatory reuse, ownership, classification, and Storybook gate for ReUI, Figma, prototypes, screenshots, legacy UI, and other external sources.
- [Storybook mobile responsiveness and mobile design](architecture/storybook-mobile-responsiveness-and-design.md) — mandatory mobile-first component contracts, touch safety, official mobile stories, responsive classifications, widths, and acceptance tests.
- [ReUI intake and ownership](architecture/reui-intake-and-ownership.md) — temporary intake, Kura promotion, provenance, and cleanup policy for ReUI registry source.
- [Product overview](../PRODUCT.md)
- [Design overview](../DESIGN.md)
- [Working context](../CONTEXT.md)
- [Operational runbook](../RUNBOOK.md)
- [Plans index](../plans/README.md)
- [AI agent project map](../AGENTS.md)
- [Kura SDLC harness](../CLAUDE.md)
