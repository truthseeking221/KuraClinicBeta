...
- [Phone gate journey](phone-gate-journey.md)
- [Order cart design specification](../03-design-specifications/order-cart-design-spec.md)
...
The exact no-match state is documented in the [phone gate journey](phone-gate-journey.md) and is implied by the Figma test cases even if not fully represented in this node set.
