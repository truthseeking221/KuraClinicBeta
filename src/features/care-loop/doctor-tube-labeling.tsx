...
import styles from "./doctor-tube-labeling.module.css";


/** How the clinic identifies the tubes it prepares for courier pickup. */
...
export type DoctorTubeLabelingProps = {
...
/**
 * Labelling tubes in a doctor-run clinic, before a courier collects them.
 *
 * This is NOT the PSC collection label step and must not share its authority:
 * a doctor preparing tubes at their own clinic has no label printer and no
 * accession desk, so the sticker pad and the handwriting fallback are the two
 * real routes here. PSC collection prints and scans a sample identity instead.
 *
 ...
 */
export function DoctorTubeLabeling({
  method,
  onConfirm,
  onMethodChange,
  patientLabelLine,
