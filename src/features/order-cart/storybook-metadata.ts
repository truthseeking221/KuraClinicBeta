...
export const ORDER_CART_STORYBOOK_KURA = {
  ...
  intake: {
    ...
    evidence: [
      ...
      'Backend contracts: server-priced minor-unit strings, ADR-0057 prescriber attribution, capture contract (paid is the only real capture state), doctor-banking commission_bp economics.',
    ...
    exclusions: [
      ...
      'The implementation composes existing Kura Badge, Alert, Button, IconButton, Checkbox, Collapsible, SegmentedToggle, and MoneyText owners.',
    ],
  },
  source: {
    figma: 'https://www.figma.com/design/yWz269PzVjFQquJa1U1M0s/Kura-Design?node-id=1194-3749',
    repositories: [
  ...
  binding: {
    ...
    radius: 'kura',
    motion: 'kura-control-reveal + compositor-only + immediate-close + reduced-motion-safe',
